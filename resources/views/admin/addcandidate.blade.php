								...
								<div class="col-xl-10">
									<form method= "POST" action="{{route ('candi')}}" enctype="multipart/form-data">
										...
										<div class="submit-field">
											...
											<input type="text" class="with-border" name= "state">
										</div>
										<div class="submit-field">
											<h5>Party Name</h5>
											<input type="text" class="with-border" name= "party_name">
										</div>
										<div class="submit-field">
											<h5>Date of Birth </h5>
											<input type="text" class="with-border" name= "dob">
										</div>
										<div class= "submit-field">
											<h5>Manifesto</h5>
											<textarea cols="10" rows="5" class="with-border" name= "manifesto"></textarea>
										</div>
										...
										<div class="row ">
                                            ...
                                            <div class="col-md-7">
                                                    <input type="file" class="filestyle upload" name="profile_picture" data-icon="false">
                                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                        <input type="file" class="filestyle upload" name="party_picture"data-icon="false">
                                                </div>
