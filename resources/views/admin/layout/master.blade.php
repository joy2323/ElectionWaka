...
<link rel="stylesheet" href="{{asset('public/css/colors/blue.css')}}">
...
<script src="{{asset('public/js/tippy.all.min.js')}}"></script>
...
<script src="{{asset('public/js/snackbar.js')}}"></script>
