...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" id="mySidebar"><br>
  <div class="w3-bar-block">
    ...
    <a href="{{url('user/poll_result')}}" class="w3-bar-item w3-button w3-padding" style="border-bottom: 2px solid #99ca49;">Your poll result</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="poll">
    ...
    <div class="footer row">
            <div class="col-md-4">
              <img class="img-fluid" src="{{asset('public/images/opavote-online-voting-203x56.png')}}"><br>
